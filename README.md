...
## I may revisit Snort logs in the future, however I will likely focus on replacing the Filebeat and Logsatsh components with a more purpose built collector.
